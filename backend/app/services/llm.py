        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "резюме. Также напиши краткое summary опыта НА АНГЛИЙСКОМ ЯЗЫКЕ "
                    "(in English), 1-2 предложения.\n\n" + resume_text[:15000]
                ),
            }
        ],
        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "как желательные, но не обязательные. Ответ пиши НА АНГЛИЙСКОМ "
                    "ЯЗЫКЕ (write the response in English)."
                ),
            }
        ],
